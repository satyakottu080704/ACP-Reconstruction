#!/usr/bin/env python3
"""
Verify the pipeline feed â€” list files in the SharePoint Pending_Draw folder.
===========================================================================
...
Usage:
    ...
    python automation/list_pending_draw.py --folder "General/AI Automation/AI_COMPLETED"
