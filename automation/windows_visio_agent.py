...
Uploads the finished VSDX back to SharePoint 'General/AI Automation/AI_COMPLETED'.
"""
...
OUTPUT_FOLDER = os.getenv("SHAREPOINT_OUTPUT_FOLDER", "General/AI Automation/AI_COMPLETED").strip().strip("/")
...
def upload_vsdx_to_sharepoint(token, local_path, project_number):
    """Upload generated VSDX to SharePoint AI_COMPLETED folder."""
